...
import OrbAttestationAbi from "./abi/OrbAttestation";
import { BONSAI_TOKEN_ADDRESS_POLYGON } from "../../utils/constants";
import { approveToken } from "../coinbase";
import { polygon } from "viem/chains";

const ORB_API_URL =
    "https://us-central1-stellar-verve-314311.cloudfunctions.net/ORBV2-BOT-tipping";
const ORB_ATTESTATION_CONTRACT_ADDRESS =
    "0xa8208529573e32b0aec07565fa8bc3cd01115449"; // polygon

// tip a publication with bonsai on polygon
export const tipPublication = async (
    wallet: Wallet,
    profileId: string,
