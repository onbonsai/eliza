...
const createPostAction = {
    ...
    handler: async (
        ...
        if (!wallets?.polygon) {
            elizaLogger.error(
                `Failed to fetch wallets for agentId: ${message.agentId}`
            );
            return;
        }
        ...
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Post to Lens where you are explaining something",
                },
            },
            {
                user: "{{agentName}}",
        ...
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Create a post on Orb where you talk about stuff",
                },
            },
            {
                user: "{{agentName}}",
        ...
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Make a Lens post on Orb explaining what you are thinking about",
                },
            },
            {
                user: "{{agentName}}",
