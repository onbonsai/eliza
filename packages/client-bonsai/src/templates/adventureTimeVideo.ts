...
import { generateVideoLuma, DEFAULT_MODEL_ID as DEFAULT_MODEL_ID_LUMA, DEFAULT_DURATION_S } from "../services/luma";
...
`;
      ...
      totalUsage.videoCostParams = { model: DEFAULT_MODEL_ID_LUMA, duration: DEFAULT_DURATION_S };
  ...
  clientMetadata: {
    ...
    image: "https://link.storjshare.io/raw/jv353tymzdmqupit7mkcjpjfmtpq/bonsai/adventureTimeVideo.png",
    options: {
      allowPreview: true,
